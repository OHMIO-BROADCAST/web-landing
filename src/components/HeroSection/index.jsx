          ...
          <div className="row align-items-center">
            <div className={ClassDiv}>
              <div className="welcome-content">
                ...
                <h1>{title}</h1>
                <p className="w-text fadeInUp" data-wow-delay="0.3s"><text style={{ textDecoration: 'underline' }}>OHMIO</text> {description1}<text style={{ textDecoration: 'underline' }}>OHMIOBOX</text> {description2}</p>
                <div className="dream-btn-group fadeInUp" data-wow-delay="0.4s" style={{display:'flex', justifyContent:'center'}}>
                  <a href="https://nab.ohmiobroadcast.io" target="_self" className="btn more-btn mr-3">{link1}</a>
                  <a href="https://main.d3thd78bg7l3yq.amplifyapp.com//" target="_blank" className="btn more-btn-app">{link2}</a>
                </div>
                <div className="dream-btn-group fadeInUp" data-wow-delay="0.4s" style={{display:'flex', justifyContent:'center'}}>
